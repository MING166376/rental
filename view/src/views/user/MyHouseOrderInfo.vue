    ...
    <div class="house-container">
      <div>
        <el-table :data="apiResult.data">
          <el-table-column prop="id" :sortable="true" width="80" label="序号"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async fetchFreshData() {
      try {
        const { data, total } = await this.$axios.post('/house-order-info/listUser', this.houseOrderInfoQueryDto);
